...
static void *dp_thread(void *arg)
{
  ...
  while (!Stop) {
    ...
    /*//////////////////////////////////////////////////////////////////////////////////////////
     * Waiter Solution Amendation
     *//////////////////////////////////////////////////////////////////////////////////////////
    
    pthread_mutex_lock(&waiter);
    if(!(available_chopsticks[id])){				//判断当前哲学家可否拿起左右的筷子
	...
	//////////////////////////////////////////////////////////////////////////////////////////// 
    pthread_mutex_lock(&waiter);//锁定waiter，此时当前哲学家将进行放下筷子的操作
    ...
    pthread_mutex_unlock(&waiter);//解锁waiter，允许其他哲学家去判断筷子的available属性以及是否可以进入eating状态
